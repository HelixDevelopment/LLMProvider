# CONSTITUTION — LLMProvider

Project-specific governance for the **LLMProvider** repository. This document carries the Universal Mandatory Constraints inherited from the cross-project root.
