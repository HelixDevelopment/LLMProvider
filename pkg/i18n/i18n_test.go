...
// TestNoopTranslator_EchoesID_ProviderDescription verifies the safety
// default echoes a provider-description message ID verbatim — a loud
// failure mode, never a silent swallow. Round-341 merge-first
// reconciliation (CONST-061): renamed from TestNoopTranslator_EchoesID
// to avoid collision with the round-337 lineage's same-named test,
// which exercises a validation-error message ID; both kept.
func TestNoopTranslator_EchoesID_ProviderDescription(t *testing.T) {
